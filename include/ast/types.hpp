...
public:
    BasicType() {}
    BasicType(const std::vector<Storage_Class_Specifier>& s_c_s_, const std::vector<Type_Specifier>& t_s_, const std::vector<Type_Qualifier>& t_q_)
        : s_c_s(s_c_s_), t_s(t_s_), t_q(t_q_)
        {}
